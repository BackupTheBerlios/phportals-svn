...
define('_MVIEW',                                    'Ansicht:');
define('_MVIEWADMIN',                               'Administratoren');
define('_MVIEWUSERS',                               'Angemeldete Benutzer');
define('_MVIEWANON',                                'G&auml;ste');
define('_MVIEWALL',                                 'Alle');
define('_MVIEWUNKNOWN',                             'Unbekannt');
define('_EXPIRELESSHOUR',                           'Verfall: weniger als 1 Stunde');
define('_EXPIREON',                                 'Verf&auml;llt am %d.%m.%Y um %H:%M');

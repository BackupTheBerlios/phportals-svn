...
echo "<!-- tinyMCE -->\n"
    ...
    . "      width : \"100%\",\n"
    . "      height : \"250px\",\n"
    . "      plugins : \"advimage,advlink,contextmenu,preview,print,save,emotions,searchreplace\",\n"
    . "      theme_advanced_buttons1_add : \"search,replace\",\n"
    . "      theme_advanced_buttons3_add : \"emotions,preview,zoom,print,save\",\n"
    . "      plugin_preview_width : \"500\",\n"
    . "      plugin_preview_height : \"600\",\n"
    . "      extended_valid_elements : \"a[name|href|target|title|onclick]\",\n"
    . "      invalid_elements : \"script,object,applet,iframe\",\n"
    . "      content_css : \"themes/$ThemeSel/style/editor.css\",\n"
    . "      language : \"de\"\n"
    . "   });\n"
    . "</script>\n"
    . "<!-- /tinyMCE -->\n";
